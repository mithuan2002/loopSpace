    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="py-24 px-6 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">LoopSpace is an calm, focused workspace for early-stage SaaS founders to collect, organize, and prioritize  feedback. Know exactly what to build next without the noise.</p>
